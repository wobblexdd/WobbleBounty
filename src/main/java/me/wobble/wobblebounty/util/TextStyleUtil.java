...
public final class TextStyleUtil {
    ...
    public static String normalLabel(String label, String value) {
        return "<gray>" + label + ":</gray> <yellow>" + value + "</yellow>";
    }

    public static String sortDisplay(String raw) {
        if (raw == null) {
            return "Unknown";
        }
    ...
    public static String smallCapsSort(String raw) {
        return smallCaps(sortDisplay(raw));
    }

    public static String displaySearch(String search) {
